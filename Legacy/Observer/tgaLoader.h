 ...
 */
int LoadTgaImage(char filename[],unsigned char** pixels,unsigned int *w,unsigned int *h,unsigned int* bpp);
int LoadTgaImageFromMemory(unsigned char* filebuf,unsigned char** pixels,unsigned int *w,unsigned int *h,unsigned int* bpp);
